...
- [職務経歴](#職務経歴)
  ...
  - [5. 動物病院検索サービス 開発（短期プロジェクト）](#5-動物病院検索サービス-開発短期プロジェクト)
...
Webエンジニアとして約6年の開発経験を持ち、主にフロントエンド・バックエンドの開発を担当。金融系、フードデリバリー、プログラミング学習サービスなどのWebサービスの開発・保守に従事し、要件定義・設計から実装、テスト、リリースまで一貫して対応。ReactやNext.jsを用いたフロントエンド開発、Node.jsやRuby on Railsを活用したAPI開発に強みを持つ。

AWS（ECS, Lambda, ALB, S3）を利用した環境での開発経験も豊富だが、インフラ専任ではなく、Webアプリケーション開発を軸としたキャリアを希望。また、これまでの経験を活かし、チームの開発プロセス改善やコード品質向上に貢献。
今後はWebエンジニアとしてのスキルを深めながら、後進の育成にも関わりたいと考えてます。


以下のフォーマットで、あなたの経験スキルを整理しました。
