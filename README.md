...
| **詳細** | ・**追加機能の要件定義、仕様策定、工数見積りを担当し、顧客・他ベンダーとのヒアリングを実施**<br> ・**認証系機能（Google Tag Manager、LINE login、LINE Messaging API）を設計・実装**<br> ・**手動オペレーションの影響が大きかった作業を自動化し、業務効率を向上**<br> 開発環境が統一されておらず、開発者ごとに異なる設定になっていたため、**Docker環境を整備し、1つのコマンドで環境を立ち上げられるように改善**。これにより、新規開発者のオンボーディング時間を短縮した。<br> また、管理画面の機能拡充により、ビジネスサイドが自ら広告の設定を変更できるようになり、開発チームの作業負担を軽減した。 |
