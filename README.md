...
2019年5月より、Webエンジニアとして約6年の開発経験を持ち、主にフロントエンド・バックエンドの開発を担当しています。  
  
正社員として所属していた企業では、自社開発の占いサービスの保守・新規開発、  
SESとして様々なシステムの開発・運用（フロントエンド・バックエンド中心）に従事しました。  
後進メンバへの知見の共有、Dockerでバックエンド、フロントエンド、インフラの各チームを横断的に対応する必要があった場合のサポートなどを行い、ボトルネックになっていたバグの解消に成功しました。

その後フリーランスとして、金融系、フードデリバリー、プログラミング学習サービスなどのWebサービスの開発・保守に従事し、プロダクトの知見が増えてきたタイミングで、サブリーダーとしてメンバーへのタスクのアサイン、バグ改善、コードレビューなどを行いました。

AWSのサーバレス技術、ECSなどのコンテナ技術、ALBやEC2などの基礎的な技術も経験がありますが、  
インフラチームではなく開発者としてインフラにも関わる方が、よりビジネスに貢献できると考えています。
