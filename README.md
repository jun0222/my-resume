...
| **詳細** | ・新規サービスの立ち上げに伴い、**企画・要件定義・設計・開発を担当**<br> ・**楽天ペイを導入し、決済機能を実装**<br> ・**ABテスト用LPの開発、管理画面の利便性向上**<br> ・**新規メンバーへの技術教育を実施し、チームの生産性向上に貢献**<br>それまで実施されていなかったLPの施策に対して、ABテストしやすいようにビジネス上変更が多い箇所は定数にするなど、ビジネスを考え構築しました。<br>リリース手順のドキュメントが煩雑だったので新規メンバーに素早く共有できるように、テキストベースのドキュメントを作成しました。 |
